...
EOF     BYTE    C'EOF FILE THIS THING IS TOO LONG TO FIT IN THE 30 BYTES WE ALLOCATED'
THREE   WORD    3
ZERO    WORD    0
RETADR  RESW    1
LENGTH  RESW    1		LENGTH OF RECORD
BUFFER  RESB    32768		32768-BYTE BUFFER AREA THAT IS TOO BIG
.
...
OUTPU2  BYTE   X'0512'		CODE FOR OUTPUT DEVICE
OUTPUT  BYTE   X'053'		CODE FOR OUTPUT DEVICE
	END    FIRST
